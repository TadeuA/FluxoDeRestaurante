...
import { FieldValues, FieldName, Options, OnSubmit, ValidationPayload, ElementLike, NameProp, ManualFieldError } from './types';
export default function useForm<FormValues extends FieldValues = FieldValues>({ mode, reValidateMode, validationSchema, defaultValues, validationFields, nativeValidation, submitFocusError, validationSchemaOption, }?: Options<FormValues>): {
    ...
    setError: {
        (name: ManualFieldError<FormValues>[]): void;
        (name: FieldName<FormValues>, type: string, message?: string | undefined): void;
    };
    ...
    triggerValidation: (payload?: ValidationPayload<FieldName<FormValues>, FormValues[FieldName<FormValues>]> | ValidationPayload<FieldName<FormValues>, FormValues[FieldName<FormValues>]>[] | undefined, shouldRender?: any) => Promise<boolean>;
    getValues: (payload?: {
        nest: boolean;
