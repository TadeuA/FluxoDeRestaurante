                ...
                case 2:
                    ...
                    return [4 /*yield*/, new Promise(function (resolve) {
                            ...
                            values.reduce(function (previous, _a, index) {
                                ...
                                return __awaiter(void 0, void 0, void 0, function () {
                                    var _c, lastChild, result, errorObject;
                                    return __generator(this, function (_d) {
                                        switch (_d.label) {
                                            ...
                                            case 1:
                                                if (!_c.apply(void 0, [_d.sent()])) {
                                                    return [2 /*return*/, resolve(previous)];
                                                }
                                                lastChild = values.length - 1 === index;
                                                if (!isFunction(validate)) return [3 /*break*/, 3];
                                                return [4 /*yield*/, validate(fieldValue_1)];
                                            case 2:
                                                result = _d.sent();
                                                ...
                                                _d.label = 3;
                                            case 3: return [2 /*return*/, lastChild ? resolve(previous) : previous];
                                        }
                                    });
                                });
                            }, {});
...
var get = (function (obj, path, defaultValue) {
    var result = path
        .split(/[,[\].]+?/)
        .filter(Boolean)
        .reduce(function (result, key) { return (!isNullOrUndefined(result) ? result[key] : result); }, obj);
...
var assignWatchFields = (function (fieldValues, fieldName, watchFields) {
    ...
    if (!isUndefined(values)) {
        getPath$1(fieldName, values).forEach(function (name) {
...
function useForm(_a) {
    ...
    var _h = __read(useState(), 2), render = _h[1];
    var _j = useRef(modeChecker(mode)).current, isOnBlur = _j.isOnBlur, isOnSubmit = _j.isOnSubmit;
    ...
    var _k = useRef(modeChecker(reValidateMode)).current, isReValidateOnBlur = _k.isOnBlur, isReValidateOnSubmit = _k.isOnSubmit;
    ...
    var triggerValidation = useCallback(function (payload, shouldRender) {
        if (shouldRender === void 0) { shouldRender = false; }
        return __awaiter(_this, void 0, void 0, function () {
            var fields, result;
            var _this = this;
    ...
    validateAndUpdateStateRef.current = validateAndUpdateStateRef.current
        ...
        : function (event) { return __awaiter(_this, void 0, void 0, function () {
            var type, target, name, fields, errors, ref, currentError, error, isBlurEvent, shouldSkipValidation, shouldUpdateDirty, shouldUpdateState, fieldErrors, shouldUpdate;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    var setInternalError = function (_a) {
        var name = _a.name, type = _a.type, message = _a.message, _b = _a.reRender, reRender = _b === void 0 ? true : _b;
    ...
    function setError(name, type, message) {
        if (type === void 0) { type = ''; }
        if (isString(name)) {
            setInternalError({ name: name, type: type, message: message });
        }
        else {
            name.forEach(function (error) { return setInternalError(__assign(__assign({}, error), { reRender: false })); });
            render({});
        }
    }
    function watch(fieldNames, defaultValue) {
        var combinedDefaultValues = defaultValue || defaultValues || {};
    ...
    function registerIntoFieldsRef(ref, validateOptions) {
        ...
        var currentField = fields[typedName];
        var isRegistered = isRadio
            ...
            : currentField;
        if (isRegistered) {
            fields[typedName] = __assign(__assign({}, currentField), validateOptions);
            return;
        }
        if (type) {
        ...
        var fieldToAttachListener = isRadio && currentField.options
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, fieldsToValidate.reduce(function (previous, field) { return __awaiter(_this, void 0, void 0, function () {
